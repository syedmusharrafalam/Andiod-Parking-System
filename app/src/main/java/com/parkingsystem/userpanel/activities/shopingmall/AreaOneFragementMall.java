...
public class AreaOneFragementMall extends Fragment{
    MallAdapter1 mallAdapter1;
   ...
   // TextView slots1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v=inflater.inflate(R.layout.mall_one_activity, container, false);
        mData=new ArrayList<>();
        recyclerView=(RecyclerView)v.findViewById(R.id.recyclerViewMall1);
        mallAdapter1=new MallAdapter1(getContext(),mData,a,b);
...
btnshow.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View v) {
        a= Long.parseLong(getTime(checkinDate,sentHour,minute,sec));
        String s=spin.getSelectedItem().toString();
        endTime= sentHour+Integer.parseInt(s);
        b= Long.parseLong(getTimeEnd(checkinDate,endTime,minute,sec));
