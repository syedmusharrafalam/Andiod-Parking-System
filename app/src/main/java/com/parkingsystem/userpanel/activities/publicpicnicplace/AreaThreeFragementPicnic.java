...
public class AreaThreeFragementPicnic extends Fragment{
    List<Booking> mData;
   ...
   // TextView slots1;
    ...
    public AreaThreeFragementPicnic()
    {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v=inflater.inflate(R.layout.picnic_three_activity, container, false);
        mData=new ArrayList<>();
