...
public class RecyclerViewAdapterTwo extends RecyclerView.Adapter<RecyclerViewAdapterTwo.MyViewHolder> {
  Context context;
    ...
    public RecyclerViewAdapterTwo(Context context, List<Booking> mBooking, long startTime, long endTime) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v;
        v= LayoutInflater.from(context).inflate(R.layout.custom_button_two,parent,false);
